...
class SellsTable extends SupabaseTable<SellsRow> {
  @override
  String get tableName => 'sells';

  @override
  SellsRow createRow(Map<String, dynamic> data) => SellsRow(data);
}

class SellsRow extends SupabaseDataRow {
  SellsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => SellsTable();
