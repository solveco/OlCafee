...
class ItemsOlaTable extends SupabaseTable<ItemsOlaRow> {
  @override
  String get tableName => 'items_ola';

  @override
  ItemsOlaRow createRow(Map<String, dynamic> data) => ItemsOlaRow(data);
}

class ItemsOlaRow extends SupabaseDataRow {
  ItemsOlaRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ItemsOlaTable();
